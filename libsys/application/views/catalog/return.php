<section>
    <h2 class="section-title">
        <?php echo $this->lang->line('catalog__section_return_title'); ?>
    </h2>
    <div class="section-content">
        ...
        <div class="choice-box">
            <?php echo $this->lang->line('catalog__borrowing_return_box'); ?>
            <div class="choice-answers">
                <a class="button" href="/catalog/return/<?php echo $book_id; ?>/<?php echo $book_user_id; ?>">
